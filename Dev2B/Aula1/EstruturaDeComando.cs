...
namespace Aula1
{
    public class EstruturaDeComando
    {
        public void Execute()
        {
            Exercicio1();
        ...
        private void Exercicio5DoWhile()
        {
        ...
        private void Exercicio6DoWhile()
        {
            int cDoWhile = 0;
        ...
        private void Exercicio7DoWhile()
        {
            decimal resultado = 0;
            int cDoWhile = 0;
        ...
        private void Exercicio8DoWhile()
        {
        ...
        private void Exercicio9DoWhile()
        {
            Console.WriteLine("Informe o numero: ");
            int n = int.Parse(Console.ReadLine());
            if (n > 100 || n < 0)
