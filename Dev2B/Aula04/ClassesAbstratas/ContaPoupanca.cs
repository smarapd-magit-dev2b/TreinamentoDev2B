...
namespace Aula04.ClassesAbstratas
{
    class ContaPoupanca: Conta
    {
        ...
        public override void AplicarRendimento()
        {
            ...
            Console.WriteLine("Informe a porcentagem do Rendimento: ");
            taxaServico = int.Parse(Console.ReadLine());

            saldo = saldo + (saldo * taxaServico) / 100;
            Console.WriteLine("O Novo Saldo após a Aplicação do Rendimento: " + saldo + " R$");
        }

        public override void AplicarTaxaServico()
        {
            Console.WriteLine("Opção disponível apenas para contas correntes");
        }
    }
}
