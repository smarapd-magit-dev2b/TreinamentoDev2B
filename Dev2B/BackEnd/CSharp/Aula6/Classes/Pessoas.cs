...
namespace Aula6.Classes
{
    ...
    {
        public static List<Pessoa> Lista { get; private set; } = new List<Pessoa>
        {
            new Pessoa
            {
                Id = 1,
                ...
                Filhos = new List<Pessoa>
                {
                    ...
                    new Pessoa
                    {
                        ...
                        Nome = "Romeu",
                        Altura = 1.9m,
                        DataNascimento = new DateTime(1900, 3, 15),
                        Peso = 100.0m,
                        Raca = "Branca",
                        Endereco = new Classes.Endereco { Logradouro = "Rua Sengoso", Bairro = "Vila Romário", Complemento = "Apartamento", Numero = 12 },
                        Filhos = null
                    }
                }
            },
